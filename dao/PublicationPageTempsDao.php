 ...
 * @author Esora Inc.
 */
class PublicationPageTempsDao extends BaseDao
{
	const TABLE_NAME = 'publication_page_temps';

const COL_PAGE_TEMP_KEY = "page_temp_key";
...
const COL_DELETEDATE = "deletedate";
	...
	public function delete($temp_key, $publication_id, $user_id)
	{
		$this->addWhereStr(self::COL_PAGE_TEMP_KEY, $temp_key);
